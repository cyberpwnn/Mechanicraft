...
public class DataCluster
{
	...
	{
		return new DataCluster().qset(data);
	}
	...
	public DataCluster qset(GMap<String, Cluster> data)
	{
		this.data = data;
		return this;
	}
	...
	{
		if(o != null && (o instanceof DataCluster))
		{
			DataCluster cc = (DataCluster) o;
