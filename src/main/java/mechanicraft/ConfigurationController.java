...
import mechanicraft.util.ASYNC;
import mechanicraft.util.Configurable;
import mechanicraft.util.Controller;
import mechanicraft.util.DataCluster;
...
public class ConfigurationController extends Controller
{
	...
	public int updateConfigurableSettings(File file, DataCluster cc)
	{
		FileConfiguration fc = loadFileConfig(file);
		int changes = 0;
